...
public class GamesTilesContainerController implements Controller<Node> {
  ...
  public enum TilesSortingOrder {
    ...
    NAME_DES(Comparator.comparing(o -> ((Game) o.getUserData()).getTitle().toLowerCase(Locale.US)), false, "tiles.comparator.nameDescending"),
    NAME_ASC(Comparator.comparing(o -> ((Game) o.getUserData()).getTitle().toLowerCase(Locale.US)), true, "tiles.comparator.nameAscending");
